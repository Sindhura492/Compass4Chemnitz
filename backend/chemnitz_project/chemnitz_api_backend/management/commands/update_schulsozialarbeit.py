...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        print("Scheduling Schulsozialarbeit update task...")
    ...
    def update_model(self):
        print("Running Schulsozialarbeit update task...")
    ...
    def process_data(self, data):
        ...
        if 'features' in data:
            for feature in data['features']:
                ...
                try:
                    existing_object = Schulsozialarbeit.objects.get(OBJECTID=object_id)
                    print(f"Object with OBJECTID {object_id} already exists. Skipping...")
                except ObjectDoesNotExist:
                    new_object = Schulsozialarbeit.objects.create(
                        X=x,
                        Y=y,
                        OBJECTID=object_id,
